...
```{r Percentage of people who has purchases more than 1 time}
  ...
  pct.paying.users <- (nrow(PR.different.purch)-repeated) * 100 / nrow(PR.different.purch) ; pct.paying.users
...
```{r Conversion rate}
  ...
  conversion.rate <- paste(as.character(round(conversion.rate, 2)), "%")
