...
In conclusion, there were 90.185 users that downloaded the game. Those users were distributed in two groups of similar size, Group A (gate 30); with 44.698 players (50,6%) and Group B (gate 40); with 45.487 players (49,4%).
The number of game rounds played was 2.294.854 (49,58%) for group A and 2.333.460 (50,42%) for group B.
...
We couldn't have enough evidence to conclude that moving the gate from the level 30 to the level 40 make any improve. The same happens with the relation between game rounds and purchases. By the result we can't intuit that there is a direct relationship between these two variables.
